...
class TestCursorAdapter:
    ...
    async def test_sync_agents(self, temp_config_dir):
        ...
        assert "Test instructions for code review" in content
...
Follow coding best practices."""
    ...
    def test_generate_cursor_rules(self):
        ...
        result = adapter._generate_cursor_rules("test-agent", "Follow best practices for Python", "engineering")

        assert "# Test Agent" in result
        assert "# Category: engineering" in result
        assert "# Generated by MyAI" in result
        assert "Follow best practices for Python" in result
